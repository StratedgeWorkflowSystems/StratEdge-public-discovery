...
- Suggested name: `stratedge-workflow-public` or `company`
- Topics: `fintech`, `workflow`, `saas`, `b2b`, `credit-union`, `document-management`
- Do **not** enable fake stars, engagement pods, or astroturfed issues.

## Push (founder)

```bash
cd github-public-repo
git init
git add .
git commit -m "Add public company facts mirror for AI and investor discovery"
git branch -M main
git remote add origin git@github.com:YOUR_ORG/stratedge-workflow-public.git
git push -u origin main
```

Replace `YOUR_ORG` with the authorized GitHub organization or user account.
